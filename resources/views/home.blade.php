                ...
                <div class="tw-flex tw-flex-col-reverse lg:tw-flex-row tw-items-center tw-gap-4" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                    <div class="col-xl-5 offset-xl-1 col-lg-6 text-center text-lg-start">
                        ...
                        <div class="tw-flex lg:tw-justify-start tw-justify-center w-100">
                            @if ($pimpinanStaff && $pimpinanStaff->id)
                                ...
                                <div class="swiper-slide">
                                    <div class="row align-items-center pt-25px pb-25px"> 
                                        <div class="col-lg-8 d-lg-flex align-items-center text-center text-lg-start">
                                            @if ($item->foto)
                                            <img src="{{asset('storage/' . $item->foto)}}" class="rounded-circle w-100px h-100px md-mb-35px tw-mx-auto" alt="">  
                                            @endif
                                            @if ($item->teks)
                                            <span class="d-block ps-40px md-ps-0 md-mx-auto position-relative"><img src="images/demo-accounting-home-quote-img.png" class="position-absolute left-minus-25px top-minus-15px lg-top-minus-5px md-top-minus-50px w-40px md-left-0px md-right-0px md-mx-auto" alt="">{!! $item->teks !!}</span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-lg-3 text-center text-lg-start md-mt-15px">
                                            @if ($item->nama)
                                            <span class="fs-19 ls-minus-05px fw-600 text-dark-gray d-block lh-28">{!! $item->nama !!}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
