...
<html class="no-js" lang="en">
    <head>
        <title>Akuntansi Perpajakan - Beranda</title>
        <meta charset="utf-8">
    ...
    <body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color="">
        ...
        <header class="header-with-topbar">
            <div class="header-top-bar top-bar-dark cover-background" style="background-color: #2E7D32; padding-top: 10px; padding-bottom: 10px;">
            ...
            <nav class="navbar navbar-expand-lg header-light header-transparent bg-transparent disable-fixed">
                <div class="container">
                    <a class="navbar-brand" href="/">
                        ...
                        <span class="brand-text text-black">Akuntansi Perpajakan</span>
                    </a>
                                    ...
                                    <li>
                                        <a href="/tentang"><i class="bi bi-info-circle"></i>
                                            <div class="submenu-icon-content">
                                                <span>Tentang Akuntansi Perpajakan</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
            ...
            <div class="container h-100 position-relative">
                <div class="row align-items-center justify-content-center h-100">
                    <div class="col-12 text-center">
                        <div class="fs-120 lh-120 sm-fs-100 text-dark-gray fw-600 ls-minus-4px" data-anime='{ "el": "lines", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 500, "staggervalue": 300, "easing": "easeOutQuad" }'>Program Studi Akuntansi Perpajakan</div>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center align-items-center flex-column flex-sm-row" data-anime='{ "el": "childs", "translateX": [15, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    ...
                    <div class="col-auto icon-with-text-style-08 text-center text-md-start">
                        <div class="feature-box feature-box-left-icon-middle d-inline-flex align-middle">
                            ...
                            <div class="feature-box-content">
                                <span class="fs-14 fw-600 text-dark-gray text-uppercase">Akuntansi Perpajakan Berprestasi</span>
                            </div>
                        </div>
                    </div>
                    <!-- end features box item -->
            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-6 content-container" style="height: 400px;" data-anime='{ "effect": "slide", "color": "#ffffff", "direction":"lr", "easing": "easeOutQuad", "delay":50 }'>
                        <h1 class="section-title">Akuntansi Perpajakan.</h1>
                        ...
                        <a href="/tentang" class="btn btn-large btn-expand-ltr text-dark-gray btn-rounded fw-700">
                            <span class="bg-base-color"></span>Tentang Akuntansi Perpajakan
                        </a>
                    </div>
                    @endif
                </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center extra-very-small-screen">
                    <div class="col-xl-8 col-lg-10 text-center position-relative page-title-extra-large" data-anime='{ "el": "childs", "translateY": [-15, 0], "opacity": [0,1], "duration": 300, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <h2 class="fw-400 ls-0px mb-0">Selamat datang di website resmi program studi Akuntansi Perpajakan IWU</h2>
                    </div>
                </div>
            </div>
        </section>
