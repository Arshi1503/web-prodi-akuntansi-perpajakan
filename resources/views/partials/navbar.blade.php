<header>
    @php
        $navTextClass = $isHome ? '!tw-text-black !hover:tw-text-gray-700' : '!tw-text-gray-800 !hover:tw-text-black';
    @endphp
    ...
    <!-- start navigation -->
    <nav class="navbar navbar-expand-lg header-transparent bg-transparent disable-fixed border-bottom border-color-transparent-white-light lg:tw-mt-[3.5rem]">
        <div class="container-fluid"> 
            ...
            <div class="col-auto menu-order left-nav ps-60px lg-ps-20px md-ps-15px">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul class="navbar-nav"> 
                        <li class="nav-item"><a href="/" class="nav-link {{$navTextClass}}">Beranda</a></li>
