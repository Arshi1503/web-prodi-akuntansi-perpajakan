...
<head>
        <title>Akuntansi Perpajakan - Kurikulum</title>
        <meta charset="utf-8">
                ...
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden"
                    ...
                    <div class="card-body p-4">
                        ...
                        <h5 class="text-dark-gray fw-700" 
                            ...
                            Kurikulum Program Studi Akuntansi Perpajakan
                        </h5>
                ...
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden"
                    ...
                    <div class="card-body p-4">
                        ...
                        <p class="w-80 xl-w-90 lg-w-100 mx-auto text-muted fs-15"
                            ...
                            data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 800, "delay": 400, "easing": "easeOutQuad" }'>
                            Struktur kurikulum Program Studi Akuntansi Perpajakan Universitas Wanita Internasional dirancang untuk membekali mahasiswa dengan pengetahuan dan keterampilan yang dibutuhkan dalam bidang teknologi informasi. Kurikulum ini mengintegrasikan pembelajaran teori dan praktik secara seimbang, dengan perhatian khusus pada pengembangan kompetensi dasar yang relevan dengan kebutuhan industri digital dan masyarakat modern.
                        </p>
