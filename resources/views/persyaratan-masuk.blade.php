...
<head>
        <title>Akuntansi Perpajakan - Persyaratan Masuk</title>
        <meta charset="utf-8">
                ...
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden"
                    ...
                    <div class="card-body p-4">
                        ...
                        data-anime='{ "opacity": [0,1], "translateY": [20, 0], "duration": 600, "delay":400, "easing": "easeOutQuad" }'>
                            Untuk dapat diterima sebagai mahasiswa Program Studi Akuntansi Perpajakan di Universitas Wanita Internasional, calon mahasiswa harus memenuhi persyaratan sebagai berikut:
                        </p>
