            ...
            <div class="container tw-space-y-10">
                ...
                <div class="tw-bg-white tw-border-l-[6px] tw-border-primary tw-p-8 tw-rounded-xl tw-shadow">
                    ...
                    <ul class="tw-list-disc tw-pl-6 !tw-list-outside tw-space-y-2 tw-text-gray-800 [&::marker]:tw-text-gray-600">
                        <li class="tw-ml-2">Menyelenggarakan pendidikan berkualitas di bidang akuntansi dan perpajakan.</li>
                        <li class="tw-ml-2">Mendorong riset yang relevan dengan kebutuhan industri.</li>
                        <li class="tw-ml-2">Menjalin kemitraan strategis dengan instansi pemerintah dan swasta.</li>
                        <li class="tw-ml-2">Mengembangkan kompetensi lulusan yang adaptif dan profesional.</li>
                    </ul>
                </div>
