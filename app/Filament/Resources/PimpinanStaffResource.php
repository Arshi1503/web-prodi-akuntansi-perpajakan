        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('status')
                    ->options([
                        'Kepala Program Studi Akuntansi Perpajakan' => 'Kepala Program Studi Akuntansi Perpajakan',
                        'Dosen' => 'Dosen',
                        'Staff' => 'Staff',
                    ])
                    ->reactive()
                ...
                ->visible(fn (Get $get) => $get('status') === 'Kepala Program Studi Akuntansi Perpajakan') 
                ->required(fn (Get $get): bool => $get('status') === 'Kepala Program Studi Akuntansi Perpajakan')
                ->columnSpanFull(),
            ]);
    }
